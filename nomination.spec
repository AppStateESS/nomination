%define name nomination
%define install_dir /var/www/phpwebsite/mod/nomination

Summary:   General Nomination Module
Name:      %{name}
Version:   %{version}
Release:   %{release}
License:   GPL
